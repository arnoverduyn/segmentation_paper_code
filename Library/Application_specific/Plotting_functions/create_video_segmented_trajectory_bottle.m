function create_video_segmented_trajectory_bottle(pose_trajectories_bottle,bottle,table,cup)
    ...
    for k = 1:1:N-3
        ...
        pose_trajectory = pose_trajectories_bottle.pose_trajectory;
        new_hom_vertices = pose_trajectory(:,:,k+1)*bottle.homogeneous_vertices;
    ...
    name = './././Output/video_segmented_trajectories_bottle';
